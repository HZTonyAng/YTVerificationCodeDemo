...
//  qwert
//
//  Created by TonyAng on 16/4/7.
//  Copyright © 2016年 TonyAng. All rights reserved.
//

#import "ViewController.h"
#import "AuthcodeView.h"
@interface ViewController ()<UITextFieldDelegate, UIAlertViewDelegate,UIAlertViewDelegate>
{
...
- (void)viewDidLoad {
    ...
    self.title = @"YTVerificationCode";
    self.view.backgroundColor = [UIColor whiteColor];
    
    //显示验证码界面
    authCodeView = [[AuthcodeView alloc] initWithFrame:CGRectMake(30, 100, 100, 40)];
...
{
    //判断输入的是否为验证图片中显示的验证码
    if ([[_input.text lowercaseString] isEqualToString:[authCodeView.authCodeStr lowercaseString]])
    {
        //正确弹出警告款提示正确
